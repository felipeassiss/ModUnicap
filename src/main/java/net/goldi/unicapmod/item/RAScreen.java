package net.goldi.unicapmod.item; // Ou o pacote correto da sua RAScreen.java
...
public class RAScreen extends Screen {
    // Textura para a foto placeholder do McLovin
    ...
    public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
        ...
        try {
            ...
            guiGraphics.fill(photoActualX, photoActualY, photoActualX + PHOTO_WIDTH, photoActualY + PHOTO_HEIGHT, 0xFFFF0000); // Quadrado vermelho se falhar
        ...
        int textColor = 0xFF000000; // Preto
